...
if networkType == 1
    ...
    net.addLayer('relu1_2', dagnn.Sigmoid(), {'conv1_2'}, {'x'});
    ...
    net.addLayer('relu1_2s', dagnn.Sigmoid(), {'conv1_2s'}, {'z'});
elseif networkType == 2
    ...
    net.addLayer('relu2_2', dagnn.ReLU(), {'conv2_2'}, {'x'});
    ...
    net.addLayer('relu2_2s', dagnn.ReLU(), {'conv2_2s'}, {'z'});
else
    %% target
    conv1_1 = dagnn.Conv('size', [3 3 3 64], 'pad', 1, 'stride', 1, 'dilate', 1, 'hasBias', true) ;
    net.addLayer('conv1_1', conv1_1, {'target'}, {'conv1_1'}, {'conv1_1f', 'conv1_1b'}) ;
